...
\usepackage{float}
\usepackage{graphicx}
\usepackage[breaklinks,colorlinks,linkcolor=black,citecolor=black,urlcolor=black,hyperfootnotes=true]{hyperref}
\makeatletter
\def\UrlAlphabet{%
...
\end{center}
\vspace*{4em}
\centerline{\Huge 关于伊鲁替尼合成的综述}

\vspace*{2em}
\centerline{\large 孙奕辰\footnote{北京大学药学院2020级3班}\quad
	胡志斌\addtocounter{footnote}{-1}\addtocounter{Hfootnote}{-1}\footnotemark\quad
	米景璇\addtocounter{footnote}{-1}\addtocounter{Hfootnote}{-1}\footnotemark\quad}
...
\end{center}
\vspace*{4em}
\centerline{\Huge Review on the synthesis of irutinib}

\vspace*{2em}
\makeatletter
\centerline{\large Yichen Sun\footnote{Class 3, Grade 2020, Peking University School of Pharmaceutical Sciences}\quad
	Zhibin Hu\addtocounter{footnote}{-1}\addtocounter{Hfootnote}{-1}\footnotemark\quad
	Jingxuan Mi\addtocounter{footnote}{-1}\addtocounter{Hfootnote}{-1}\footnotemark}
\vspace*{2em}
\section*{Abstact}
